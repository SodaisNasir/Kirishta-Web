...
const BookLanguagesManagement = () => {
  ...
  const languages = user.privilage["Settings Management"]["Book Language"];
  const hasDeleteAccess = languages.Delete;
  const hasEditAccess = languages.Edit;
  const hasCreateAccess = languages.Create;
